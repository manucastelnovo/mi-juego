...
Comentás y abrís PRs con la cuenta del PO; **empezá cada comentario con tu tarjeta de
rol**: `### 🧑‍💻 Dev · Salto Games`. Las `gh` son las normales (sin tokens). Comentarios
**cortos y funcionales**: qué implementaste / qué probar, sin volcados técnicos.
